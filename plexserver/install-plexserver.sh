...
iocage exec plexserver sysrc "plexmediaserver_plexserver_enable=YES"
iocage exec plexserver sysrc plexmediaserver_plexserver_support_path="/config"
iocage exec plexserver service plexmediaserver_plexserver start
#
echo "Access plexserver @ $plexip:32400/web"