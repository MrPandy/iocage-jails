...
echo "Stopping transmission service in 5s"
sleep 5
...
sed -i .orig 's/"rpc-whitelist": "127.0.0.1",/"rpc-whitelist": "0.0.0.0",/g' $settings
sed -i .orig 's/"rpc-whitelist-enabled": true,/"rpc-whitelist-enabled": false,/g' $settings
